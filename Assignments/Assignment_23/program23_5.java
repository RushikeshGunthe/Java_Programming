...
class program23_5
{
    ...
    public static void main(String args[]) 
    {
        ...
        System.out.println("Product of all elements in array is: " + iRet);
...
// Discription:     Calculates the product of all elements in the array and returns it
// Input:           Integer
// Output:          Integer
//
...
class ArrayX 
{
    ...
    // Method to to return product of all elements in the array
    public int Product() 
    {
