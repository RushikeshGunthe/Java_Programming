...
class program24_2
{
    ...
    public static void main(String args[]) 
    {
        ...
        System.out.println("Minimum of all elements in array is: " + iRet);
...
// Discription:     Finds the Minimum number from the array and returns it
// Input:           Integer
// Output:          Integer
//
...
class ArrayX 
{
    ...
    // Method to to return Minimum of all elements in the array
    public int Minimum() 
    {
        int iCnt = 0, iMin = 0;
